...
export class AngularFormsDataService {
  // V1
  cars = [
    { id: 1, name: 'Volvo', nested: { countryId: 'L', name: 'Lithuania' } },
    { id: 2, name: 'Saab', nested: { countryId: 'U', name: 'Usa' } },
    {
      id: 3,
      name: 'Opel',
      disabled: true,
      nested: { countryId: 'T', name: 'Turkey' },
    },
    { id: 4, name: 'Audi', nested: { countryId: 'A', name: 'Arabia' } },
    { id: 5, name: 'Togg', nested: { countryId: 'T', name: 'Turkey' } },
  ];
  ...
  // term:string = null
  getCars() {
    return of(this.cars).pipe(delay(3000));
  }
